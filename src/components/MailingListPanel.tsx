        ...
        <div className="grid gap-0 lg:grid-cols-[1.15fr_0.85fr]">
          <div className="border-b border-border px-6 py-7 lg:border-b-0 lg:border-r sm:px-8">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-7 text-muted-foreground">
              매일 생성된 Global AI Daily Brief를 메일로 받아볼 수 있습니다. 구독은 확인 메일의 링크를 눌러야 활성화되며, 구독 취소는 이 화면에서 바로 처리되거나 기존 메일 하단 링크로도 할 수 있습니다.
            </p>
          </div>
          ...
          <div className="px-6 py-7 sm:px-8">
            ...
            <p className="mt-3 text-xs leading-6 text-muted-foreground">
              같은 이메일을 다시 등록해도 중복으로 쌓이지 않고 기존 상태를 기준으로 확인 메일만 다시 보낼 수 있습니다.
            </p>
