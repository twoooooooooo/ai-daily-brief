    ...
    const status: BriefingOperationalStatus = {
      ...
      recentJobs: {
        ...
        email: recentEmailJobs.map((job) => ({
          ...
          edition: job.edition,
          briefingId: job.briefingId,
          totalRecipientCount: job.totalRecipientCount,
          attemptedRecipientCount: job.attemptedRecipientCount,
          recipientCount: job.recipientCount,
          failedRecipientCount: job.failedRecipientCount,
          reason: job.reason,
          error: job.error,
        })),
      },
      latestEmailJob: latestEmailJob ? {
        ...
        totalRecipientCount: latestEmailJob.totalRecipientCount,
        attemptedRecipientCount: latestEmailJob.attemptedRecipientCount,
        recipientCount: latestEmailJob.recipientCount,
        failedRecipientCount: latestEmailJob.failedRecipientCount,
